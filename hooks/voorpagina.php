...
function ag_vp_print_menu()
{
	...
	if (array_key_exists('voorpagina', $locaties)) {
		...
		if ($menu_stukken and count($menu_stukken)) :
			echo "<section class='vp-menu verpakking verpakking-veel paddingveld marginveld veel normale-padding achtergrond-zijkleur'>";
			echo "<h2 class='tekst-wittig geen-margin-top lineheight-fix' >Lees meer over...</h2>";
