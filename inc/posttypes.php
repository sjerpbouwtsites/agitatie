...
{
    public function __construct($enkelvoud, $meervoud = '', $overschrijven = array())
    {
        if (empty($meervoud)) {
        ...
        $beschrijving = array_key_exists('description', $overschrijven) ? $overschrijven['description'] : null;
    ...
    public function pas_args_aan($args)
    {
        foreach ($args as $k => $v) {
            $this->args[$k] = $v;
        }
    ...
    public function maak_taxonomie($tax_enkelvoud = '', $tax_meervoud = '')
    {
        ...
        register_taxonomy(
            ...
            array(
                ...
                'public' 	=> true,
                'rewrite'   => array('slug'=>$tax_enkelvoud)
